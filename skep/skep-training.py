...
param_path = f'config{os.sep}roberta_skep_large_en.SST-2.cls.json'


args = args.build_common_arguments()
log.init_log(os.path.join(log_dir, "train"), level=logging.DEBUG)
param_dict = params.from_file(param_path)
